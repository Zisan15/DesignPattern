...
public class MediatorRunner {
    void mediatorDemo(){
        ...
        actor1.sendMessage("Topic2", "Message for Topic-2"); // normalde actor2 karsiliyacak
        actor1.sendMessage("Topic3", "Message for Topic-3"); // normalde actor3 karsiliyacak
        actor1.sendMessage("Topic4", "Message for Topic-4"); // normalde actor 4 karsiliyacak

        actor2.sendMessage("Topic1", "Message for Topic-1"); // normalde actor 1 karsiliyacak
